class HumorousUnitsOfMeasurement::Scraper 
	...
	def self.scrape_units_of_measurement
		...
		definitions = get_page.css("div.mw-parser-output h3 + p").children
		# binding.pry
		...
		measurement_eight =  HumorousUnitsOfMeasurement::Measurements.new(categories_array[7])
			measurement_eight.term = terms_array[26], terms_array[28], terms_array[29], terms_array[30], terms_array[31], terms_array[32], terms_array[33], terms_array[34], terms_array[35], terms_array[36], terms_array[37], terms_array[38]
	end
end